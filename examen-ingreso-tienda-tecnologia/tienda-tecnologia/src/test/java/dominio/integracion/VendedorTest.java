...
public class VendedorTest {
	...
	private static final String NOMBRE_CLIENTE = "Martin Elias";
	...
	@Test
	public void productoCodigoInvalidoTest() {
		Producto producto = new ProductoTestDataBuilder().conNombre(COMPUTADOR_LENOVO).conCodigo("ABCDEIO").build();
		...
		try {
			...
			Assert.assertEquals(Vendedor.EL_PRODUCTO_TIENE_MAL_CODIGO, e.getMessage());
		}
	}
}
